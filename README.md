...
**TKTK: Describe laquan-timeline here.**
...
View the [sample copy spreadsheet](https://docs.google.com/spreadsheet/pub?key=1v_MaUIy1fJqXk3jUz1CW2PV0Z0Mk8L5eqHyAdUnHK_w#gid=0).
...
def read_my_google_doc():
    ...
    get_document('1v_MaUIy1fJqXk3jUz1CW2PV0Z0Mk8L5eqHyAdUnHK_w', file_path)
    data = Copy(file_path)
...
```
* * * * * ubuntu bash /home/ubuntu/apps/laquan_timeline/repository/cron.sh fab $DEPLOYMENT_TARGET cron_jobs.test
```
...
|--------|------|-----|-----|
|laquan-timeline|tweet|`location`||
|laquan-timeline|facebook|`location`||
|laquan-timeline|email|`location`||
|laquan-timeline|new-comment||
|laquan-timeline|open-share-discuss||
|laquan-timeline|close-share-discuss||
|laquan-timeline|summary-copied||
|laquan-timeline|featured-tweet-action|`action`|
|laquan-timeline|featured-facebook-action|`action`|
