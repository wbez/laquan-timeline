...
PROJECT_SLUG = 'laquan-timeline'

# Project name to be used in file paths
PROJECT_FILENAME = 'laquan_timeline'

# The name of the repository containing the source
REPOSITORY_NAME = 'laquan-timeline'
...
COPY EDITING
"""
COPY_GOOGLE_DOC_KEY = '1v_MaUIy1fJqXk3jUz1CW2PV0Z0Mk8L5eqHyAdUnHK_w'
